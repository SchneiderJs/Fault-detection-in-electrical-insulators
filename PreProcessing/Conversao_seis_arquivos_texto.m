...
A=[L1,x2,y1,y3,y5,y7,y9,y11,y13,y15,y17,y19,y21,y23];
dlmwrite('IsoladorBOM_sem_filtro.txt', A, 'delimiter', ',', 'precision', 9);
A=[L1,x2,y2,y4,y6,y8,y10,y12,y14,y16,y18,y20,y22,y24];
dlmwrite('IsoladorBOM_com_filtro.txt', A, 'delimiter', ',', 'precision', 9);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Isolador Perfurado
L2=transpose(linspace(2,2,length(y1)));
A=[L2,x2,y25,y27,y29,y31,y33,y35,y37,y39,y41,y43];
dlmwrite('IsoladorPERFURADO_sem_filtro.txt', A, 'delimiter', ',', 'precision', 9);
A=[L2,x2,y26,y28,y30,y32,y34,y36,y38,y40,y42,y44];
dlmwrite('IsoladorPERFURADO_com_filtro.txt', A, 'delimiter', ',', 'precision', 9);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Som Abiente
L3=transpose(linspace(3,3,length(y1)));
A=[L3,x2,y45,y47,y49,y51,y53];
dlmwrite('somAMBIENTE_sem_filtro.txt', A, 'delimiter', ',', 'precision', 9);
A=[L3,x2,y46,y48,y50,y52,y54];
dlmwrite('somAMBIENTE_com_filtro.txt', A, 'delimiter', ',', 'precision', 9);
